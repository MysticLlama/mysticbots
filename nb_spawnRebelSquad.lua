...
function ENT:Think()
	if not self.spawnedSquad then
		s1 = ents.Create("nb_rebel2")
		s2 = ents.Create("nb_rebel2")
		s3= ents.Create("nb_rebel2")
		s4= ents.Create("nb_rebel2")
...
list.Set( "NPC", "nb_spawnRebelSquad", {
	Name = "Spawn a Rebel Squad",
	Class = "nb_spawnRebelSquad",
	Category = "MysticBot"
} )
