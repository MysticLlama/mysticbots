...
function ENT:RunBehaviour()
	...
	enemies = ents.FindByClass("nb_testCombine")
...
function ENT:OnInjured( info )
	...
	self:EmitSound( "vo/npc/male01/ow0"..tostring(math.random(1,2))..".wav" )
...
function ENT:OnKilled(info)
	...
	self:EmitSound("vo/npc/male01/pain0"..tostring(math.random(1,9))..".wav")
